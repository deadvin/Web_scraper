...
ban_list = [1324465509417574402,1305904514487083008,1266613947458699264,1034478294677250048,
           ...
           3306286357,2768661213,121158213,42213904,17340970,321271735, 804202754226810880]
...
acc_list_words = []
acc_list_words.append({'name': 'btc', "list": ["btc", "bitcoin", "crypto", "cryptocurrencies", "cryptocurrency"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'ada', "list": ["ada", "cardano", "adausdt"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'luna', "list": ["#luna", "terra", "lunausdt","terra luna","terraluna"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'eth', "list": ["ethetium", "eth", "ethusdt"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'near', "list": ["NEARProtocol", "nearusdt", "#near","NEAR Protocol"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'atom', "list": ["cosmos", "atomusdt", "#atom"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'avax', "list": ["avax", "avaxusdt"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'ftm', "list": ["ftm", "#fantom", "ftmusdt"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'one', "list": ["harmonyone", "oneusdt","harmony one"], 'num': 0, 'num_vol': 0})
...
acc_list_words.append({'name': 'inj', "list": ["inj", "injectiveprotocol", "injusdt", "injective protocol"], 'num': 0, 'num_vol': 0})
...
acc_list_words.append({'name': 'dot', "list": ["polkadot", "dotusdt"], 'num': 0, 'num_vol': 0})
...
acc_list_words.append({'name': 'axs', "list": ["axs", "axsusdt", "AxieInfinity", "Axie Infinity"], 'num': 0, 'num_vol': 0})
...
acc_list_words.append({'name': 'ar', "list": ["arusdt", "arweave"], 'num': 0, 'num_vol': 0})
...
acc_list_words.append({'name': 'etc', "list": ["etc", "etcusdt", "ethereumclassic","ethereum classic"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'egld', "list": ["elrond", "egld", "egldusdt"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'fil', "list": ["file coin", "filusdt", "filecoin"], 'num': 0, 'num_vol': 0})
acc_list_words.append({'name': 'gala', "list": ["gala coin","gala games", "galausdt", "galagames"], 'num': 0, 'num_vol': 0})
...
acc_list_words.append({'name': 'ape', "list": ["apeusdt", "apecoin", "bored ape","ape coin"], 'num': 0, 'num_vol': 0})
    ...
    def on_status(self, status):
        ...
        if status.user.followers_count > 10000:
            ...
            if not is_retweet and status.user.followers_count > 100000:
                ...
                if Utils.contains(crypto_word_list, text, False):
...
def main():
    ...
    stream.filter(languages=["en"], track=search_q, stall_warnings=True)
